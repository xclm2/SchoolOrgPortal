<div class="container-fluid dashboard">
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Organizations</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{$totalOrganizations}}
                                </h5>
                            </div>
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-7">
            <div class="card z-index-2">
                <div class="card-header pb-0">
                    <h6>Total Number of Users by Course</h6>
                </div>
                <div class="card-body p-3">
                    <div class="chart js-users-by-course-chart">
                        <canvas id="users-by-course-chart" class="chart-canvas" height="300"></canvas>
                    </div>
                </div>
            </div>
            <div class="card z-index-2 mt-3">
                <div class="card-header pb-0">
                    <h6>Total Events per Organization</h6>
                </div>
                <div class="card-body p-3">
                    <div class="chart js-total-events">
                        <canvas id="total-events" class="chart-canvas" height="300"></canvas>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card z-index-2">
                <div class="card-header pb-0">
                    <h6>Total Organizations by Course</h6>
                </div>
                <div class="card-body p-3">
                    <div class="chart js-organization-chart">
                        <canvas id="org-chart" class="chart-canvas" height="300"></canvas>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="{{$this->getImage($event->organization_id, 'logo')}}" class="avatar avatar-sm me-3" alt="xd">
                                            </div>
        ...
        @script
            <script>
                document.addEventListener('livewire:navigated',  () => {
                    ...
                    $('.js-total-events').events({!! $eventsChart !!});
                })
            </script>
        @endscript
    </div>
