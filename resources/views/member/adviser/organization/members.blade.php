                            ...
                            <tr>
                                ...
                                @if($this->isAllowEdit())
                                    <td class="align-middle">
                                        <a href="javascript:;" class="text-danger font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Remove from Organization">
                                            Remove
                                        </a>
                                    </td>
                                @endif
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <a wire:click="deleteMember({{$pendingMember->member_id}})"
                                           ...
                                           href="javascript:;" class="text-danger font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Remove from Organization">
                                            Remove
                                        </a>
                                    </td>
                                </tr>
