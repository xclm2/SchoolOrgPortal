<div class="group-message">
    <div class="card card-frame">
        ...
        <div class="card-body">
            <div class="message-list min-height-600 p-2">
        ...
        <div class="card-footer">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Aa" aria-label="Aa" aria-describedby="chat_input">
                <button class="btn btn-primary mb-0" type="button" id="chat_input">
                    Send
                    <i style="font-size: 1rem;" class="fa-regular fa-paper-plane ps-2 pe-2 text-center text-dark"></i>
