                ...
                <div class="card-body pt-4 p-3">
                    <form action="/user-profile" method="POST" role="form text-left">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="user-name" class="form-control-label">{{ __('Lastname') }}</label>
                                    <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="{{ auth()->user()->name }}" type="text" placeholder="Name" id="user-name" name="name">
                                        @error('name')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="account_type" class="form-control-label">{{ __('Account Type') }}</label>
                                    <div class="@error('account_type')border border-danger rounded-3 @enderror">
                                        <select name="account_type" id="account_type" class="form-select">
                                            <option>Select</option>
                                            <option value="bsit">Admin</option>
                                            <option value="bsit">Adviser</option>
                                            <option value="bsit">Student</option>
                                        </select>
                                        @error('account_type')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
