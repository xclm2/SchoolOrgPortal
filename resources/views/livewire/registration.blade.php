        ...
        <div class="col-md-4">
            <div class="registration__form js-registration-form">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p wire:ignore class="organization-selected rounded">
                            <span class="js-organization-name font-weight-bold">Select Organization</span>
                        </p>
            ...
            document.addEventListener('livewire:navigated', () => {
                ...
                document.querySelectorAll('.js-select-org').forEach(btn => {
                    btn.addEventListener('click', function () {
                        Livewire.find('{{$this->id()}}').set('organization_id', this.getAttribute('data-id'));
