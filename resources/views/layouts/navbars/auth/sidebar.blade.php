...
<div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap flex-column">
        ...
        <span class="badge badge-primary text-dark">Admin</span>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        ...
        <li class="nav-item pb-2">
            <a class="nav-link {{ (Request::is('admin/config/notification') ? 'active' : '') }}" href="{{ url('admin/config/notification') }}" wire:navigate>
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i style="font-size: 1rem;" class="fas fa-lg fa-bell ps-2 pe-2 text-center text-dark {{ (Request::is('admin/config/notification') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                </div>
                <span class="nav-link-text ms-1">Notification Settings</span>
            </a>
        </li>
        <li class="nav-item">
